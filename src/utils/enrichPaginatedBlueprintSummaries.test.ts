...
import {
  enrichBlueprintSummaryPage,
  enrichPaginatedBlueprintSummaries,
} from "./enrichPaginatedBlueprintSummaries";
...
describe("enrichBlueprintSummaryPage", () => {
  ...
  it("should throw validation error for invalid raw data", () => {
    ...
    expect(() => enrichBlueprintSummaryPage(invalidRawPage)).toThrow(
          ...
          data: [
            {
              ...
              numberOfFavorites: 3,
              key: "blueprint3",
              thumbnail: "http://localhost:8787/legacy-imgur/img3/thumbnail.gif",
            },
          ],
          hasMore: false,
          lastKey: null,
