...
describe('enrichBlueprint', () =>
{
	...
	it('handles V14 blueprint strings', () =>
	{
		const v14Blueprint = {
			...rawBlueprint,
			blueprintString: validV14BlueprintString,
		};
		const result = enrichBlueprint(v14Blueprint, blueprintId);
		expect(result.parsedData).toEqual({
			blueprint: {
				entities: [],
				item    : 'blueprint',
