...
describe("blueprintParser", () => {
  describe("corrupted data handling", () => {
    ...
    it("should handle corrupted compressed data gracefully", () => {
      ...
      expect(() => deserializeBlueprint(corruptedCompressed)).toThrow(
    ...
    it("should handle invalid JSON data gracefully", () => {
      ...
      expect(() => deserializeBlueprint(invalidJsonCompressed)).toThrow(
    ...
    it("should handle schema validation errors gracefully", () => {
      ...
      expect(() => deserializeBlueprint(invalidSchemaCompressed)).toThrow(
        "Invalid raw blueprint data",
      );
