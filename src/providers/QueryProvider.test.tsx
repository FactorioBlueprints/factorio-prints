...
function createPersister(restoreClient: Persister['restoreClient'] = vi.fn().mockResolvedValue(undefined)): Persister {
	return {
...
describe('QueryProvider', () => {
	...
	it('uses a finite retention below the browser timer limit', () => {
		...
		const contentAddressedBlueprint = blueprintQuery('blueprint-id', {} as EnrichedBlueprintSummary);
