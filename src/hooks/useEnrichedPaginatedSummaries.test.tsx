  ...
  data: [
    {
      ...
      height: 256,
      width: 512,
      thumbnail: "http://localhost:8787/legacy-imgur/img1/thumbnail.png",
    },
    {
      key: "blueprint2",
      title: "Test Blueprint 2",
      ...
      numberOfFavorites: 20,
      lastUpdatedDate: 2000,
      thumbnail: "http://localhost:8787/legacy-imgur/img2/thumbnail.jpeg",
    },
  ],
  hasMore: true,
  lastKey: "blueprint2",
  ...
  data: [
    {
      ...
      numberOfFavorites: 30,
      lastUpdatedDate: 3000,
      thumbnail: "http://localhost:8787/legacy-imgur/img3/thumbnail.png",
    },
  ],
  hasMore: false,
  lastKey: null,
...
describe("useEnrichedPaginatedSummaries", () => {
  ...
  it("should pass custom parameters to fetch function", async () => {
    const { result } = renderHook(() => useEnrichedPaginatedSummaries(30, "numberOfFavorites"), {
      wrapper,
    });
  ...
  it("should populate individual blueprint summaries in cache", async () => {
    ...
    expect(
      queryClient.getQueryData(["blueprintSummaries", "blueprintId", "blueprint1"]),
    ).toStrictEqual(exampleRawPage1.data.blueprint1);
    expect(
      queryClient.getQueryData(["blueprintSummaries", "blueprintId", "blueprint2"]),
    ).toStrictEqual(exampleRawPage1.data.blueprint2);
  });
