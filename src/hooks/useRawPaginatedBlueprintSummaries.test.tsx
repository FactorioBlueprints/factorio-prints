...
describe("useRawPaginatedBlueprintSummaries", () => {
  ...
  it("should fetch and return raw paginated blueprint summaries", async () => {
    ...
    queryClient.setQueryData(
      ["blueprintSummaries", "blueprintId", "blueprint1"],
      fakeRawData.data.blueprint1,
    );
    queryClient.setQueryData(
      ["blueprintSummaries", "blueprintId", "blueprint2"],
      fakeRawData.data.blueprint2,
    );

    const cachedSummary1 = queryClient.getQueryData([
      "blueprintSummaries",
      "blueprintId",
      "blueprint1",
    ]);
    const cachedSummary2 = queryClient.getQueryData([
      "blueprintSummaries",
      "blueprintId",
      "blueprint2",
    ]);
