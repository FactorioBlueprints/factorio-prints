...
const MyFavoritesGrid: React.FC = () => {
	...
	if (!user) {
		return (
			<div className="p-5 rounded-lg jumbotron">
				...
				<p className="lead">Please log in with Google or GitHub in order to view your favorite blueprints.</p>
			</div>
		);
	}
	...
	return (
		<Container fluid>
			...
			>
				<p>
					You haven't favorited any blueprints yet. Browse blueprints and click the heart icon to add them to
					your favorites.
				</p>
			</EmptyResults>
