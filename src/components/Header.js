		...
		if (user) {
			return (
				<Dropdown className="text-light">
					<Dropdown.Toggle variant="link">My Account</Dropdown.Toggle>
					<Dropdown.Menu align="end">
						<Dropdown.Item className="user-photo-container">{getDisplayName()}</Dropdown.Item>
						<Nav.Link
							as={Link}
							href="/favorites"
							to="/favorites"
		...
		>
			...
			<Navbar.Collapse>
				<Nav>
					...
					<Nav.Link
						href="https://factorioprints.com/create"
						to="https://factorioprints.com/create"
						className="text-light"
					>
						<FontAwesomeIcon
							icon={faPlusSquare}
					...
					<Nav.Link
						...
						to="https://www.patreon.com/FactorioBlueprints"
						className="text-dark"
						target="_blank"
			...
			<Nav className="justify-content-end">{renderAuthentication()}</Nav>
		</Navbar>
	);
}
