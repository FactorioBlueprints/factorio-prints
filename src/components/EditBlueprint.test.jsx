...
const mockBlueprint = {
	...
	blueprintString:
		'0eNqVkMEKgzAMht8l5-q4fWo66csQioPgtAolstXQ6ph093YOdmNjMHr5c_IlP2E3y7RwzqhzVkDuy9in_mT5wG3Sro_cm75NK386cX136e1B7pnSoABpPerAaMy81S3LNjmuKJtrFgTrxb5xhiyYqrIJGJuDuBVMHTOXP9xLtKGVaENKAoZSkgEJl-JCSjK0bQJF7F0hKBJXiCJ6QvQ=',
...
describe.skip('EditBlueprint Component - Imgur URL Integration Tests', () => {
	let queryClient;
	...
	describe('Updating image URL', () => {
		it('should validate and resolve new image URL', async () => {
			...
			await waitFor(() => {
				expect(vi.mocked(parseImgurUrl.parseImgurUrl)).toHaveBeenCalledWith(
					'https://i.imgur.com/newimage123.jpg',
				);
		...
		it('should handle validation errors for invalid URLs', async () => {
			...
			await waitFor(() => {
				expect(
					screen.getByText(/Unable to preview image. Please ensure you're using a valid Imgur URL./),
				).toBeInTheDocument();
			});
