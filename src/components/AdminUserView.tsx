...
const AdminUserView: React.FC = () => {
  ...
  const { blueprintSummaries } = useEnrichedBlueprintSummaries(
    userBlueprintsData || {},
    userBlueprintsSuccess,
  );
  ...
  return (
    <Container fluid>
      ...
      <Tabs defaultActiveKey="blueprints" className="mb-3">
        <Tab eventKey="blueprints" title={`Blueprints (${sortedBlueprints.length})`}>
        ...
        <Tab eventKey="favorites" title={`Favorites (${sortedFavorites.length})`}>
          <Row className="blueprint-grid-row justify-content-center">
