...
describe("AuthenticationForm", () => {
  ...
  it("maps provider failures to actionable messages", () => {
    expect([
      ...
      getProviderAuthenticationErrorMessage(
        new FirebaseError("auth/operation-not-allowed", "Provider disabled"),
      ),
      getProviderAuthenticationErrorMessage(
        new FirebaseError("auth/popup-blocked", "Popup blocked"),
      ),
      getProviderAuthenticationErrorMessage(
        new FirebaseError("auth/unauthorized-domain", "Unauthorized domain"),
      ),
      getProviderAuthenticationErrorMessage(
        new FirebaseError("auth/internal-error", "Unexpected failure"),
      ),
