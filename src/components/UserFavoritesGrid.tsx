					...
					cleanupInvalidUserFavorite(userId, blueprintId)
						.then((success: boolean) => {
							if (success) {
								...
								queryClient.setQueryData(['blueprints', 'blueprintId', blueprintId], (oldData: any) => {
		...
		return (
			<Container fluid>
				...
				<div className="p-5 rounded-lg jumbotron">
					...
					<p className="lead">
						Please log in with Google or GitHub to check moderator permissions for viewing this user's
						favorites.
					</p>
				</div>
			</Container>
