      ...
      <Table bordered hover>
        <tbody>
          <tr>
            ...
            <td>
              <DisplayName userId={authorUserId} externalIsLoading={isLoading} />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <DateDisplay date={createdDate} isLoading={isLoading} />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <DateDisplay date={lastUpdatedDate} isLoading={isLoading} />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <FavoriteCount count={numberOfFavorites} isLoading={isLoading} />
            </td>
          </tr>
        </tbody>
      </Table>
