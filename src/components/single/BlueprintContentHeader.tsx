...
function getBlueprintBook(data: BlueprintItemData, blueprintStringSha: string, blueprintKey: string, positionArray: number[])
{
...
function BlueprintContentHeader({data, blueprintStringSha, blueprintKey, positionArray = []}: BlueprintContentHeaderProps)
{
